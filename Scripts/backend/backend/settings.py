...
SECRET_KEY = 'django-insecure-*%5sg-jvod)wu9a@q#ye!zic@p1inb@m-^6f(v!4xt-cg!7fx+'
...
DATABASES = {
     'default': {
         ...
         'NAME': 'teleproy_telemetppcc',
         'USER': 'teleproy',
         'PASSWORD': 'x3sWX99Gn2s!!',
         'HOST': '51.79.81.98',
         'PORT': '3306',
     },
}
...
JAZZMIN_SETTINGS = {
    ...
    "site_logo": None,
    "welcome_sign": "Bienvenido al sitio de Administración de TELEMET",
    ...
    "topmenu_links": [
        ...
        {"name": "TELEMET", "url": "home", "permissions": ["auth.view_user"]},
